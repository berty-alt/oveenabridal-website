...
| P0-05 | Connect GitHub and establish `main`/`develop` workflow | Owner + Codex | In Progress | `codex/github-ci` | Git metadata, `.github/workflows/ci.yml`, `TASKS.md`, `HANDOFF.md` | Owner approval to publish the initial branches and configure protection | Local `origin` targets the owner repository; CI is review-ready; initial push, `develop`, and branch protection remain pending |
